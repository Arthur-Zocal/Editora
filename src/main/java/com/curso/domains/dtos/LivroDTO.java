...
public class LivroDTO {
    ...
    @NotNull(message = "O campo autor nao pode ser nulo")
    private int idAutor;
    private String nome;
    ...
    public void setNumeroPaginas(@NotNull(message = "O campo numeroPaginas nao pode ser nulo") @NotBlank(message = "o campo numeroPaginas nao pode estar vazio") int numeroPaginas) {
    ...
    public void setIdEditora(@NotNull(message = "O campo editora nao pode ser nulo") int idEditora) {
    ...
    public void setIdAutor(@NotNull(message = "O campo autor nao pode ser nulo") int idAutor) {
